...
public class CurrentExhibtionResponse implements Serializable, Parcelable
{
    ...
    @SerializedName("data")
    @Expose
    private List<com.exhibtion.model.CurrentExhibtionData> data = null;
    ...
    protected CurrentExhibtionResponse(Parcel in) {
        in.readList(this.data, (com.exhibtion.model.CurrentExhibtionData.class.getClassLoader()));
    ...
    public List<com.exhibtion.model.CurrentExhibtionData> getData() {
        return data;
    }

    public void setData(List<com.exhibtion.model.CurrentExhibtionData> data) {
        this.data = data;
    }
