...
public class PreviousExhibtionData implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<PreviousExhibtionData> CREATOR = new Creator<PreviousExhibtionData>() {


        @SuppressWarnings({
                "unchecked"
        })
        public PreviousExhibtionData createFromParcel(Parcel in) {
            return new PreviousExhibtionData(in);
        }

        public PreviousExhibtionData[] newArray(int size) {
            return (new PreviousExhibtionData[size]);
        }

    }
            ;
    private final static long serialVersionUID = 5660415894314952496L;

    protected PreviousExhibtionData(Parcel in) {
